...
На странице [[how-to-use-wiki|Как пользоваться базой знаний]] можно найти описание всех возможностей сайта, которые помогут найти нужную информацию максимально быстро и удобно.
...
- [[how-to-use-wiki|Как пользоваться базой знаний]]
